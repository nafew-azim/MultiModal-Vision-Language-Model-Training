...
---
## Sample Medical Image Cases
<img width="1200" height="894" alt="image" src="https://github.com/user-attachments/assets/83e5ea76-e637-4004-aa05-b057f93298a5" />

*Sample chest X-ray cases showing ground truth findings and predictions from two approaches. Each column (A–D) represents a different patient case, with visual overlays highlighting areas of interest. The table summarizes key observations, including pleural effusion, cardiomegaly, atelectasis, lung opacity, and other clinical findings.*
